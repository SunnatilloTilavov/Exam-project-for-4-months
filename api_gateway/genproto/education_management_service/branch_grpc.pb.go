...
const (
	BranchService_GetByID_FullMethodName = "/education_management_service.BranchService/GetByID"
	BranchService_GetList_FullMethodName = "/education_management_service.BranchService/GetList"
	BranchService_Create_FullMethodName  = "/education_management_service.BranchService/Create"
	BranchService_Update_FullMethodName  = "/education_management_service.BranchService/Update"
	BranchService_Delete_FullMethodName  = "/education_management_service.BranchService/Delete"
)
...
type BranchServiceClient interface {
	GetByID(ctx context.Context, in *BranchID, opts ...grpc.CallOption) (*GetBranchResponse, error)
	GetList(ctx context.Context, in *GetListBranchRequest, opts ...grpc.CallOption) (*GetListBranchResponse, error)
	Create(ctx context.Context, in *CreateBranchRequest, opts ...grpc.CallOption) (*BranchResponse, error)
	Update(ctx context.Context, in *UpdateBranchRequest, opts ...grpc.CallOption) (*GetBranchResponse, error)
	Delete(ctx context.Context, in *BranchID, opts ...grpc.CallOption) (*BranchEmpty, error)
}
...
func (c *branchServiceClient) GetByID(ctx context.Context, in *BranchID, opts ...grpc.CallOption) (*GetBranchResponse, error) {
...
func (c *branchServiceClient) Create(ctx context.Context, in *CreateBranchRequest, opts ...grpc.CallOption) (*BranchResponse, error) {
...
func (c *branchServiceClient) Update(ctx context.Context, in *UpdateBranchRequest, opts ...grpc.CallOption) (*GetBranchResponse, error) {
	out := new(GetBranchResponse)
...
func (c *branchServiceClient) Delete(ctx context.Context, in *BranchID, opts ...grpc.CallOption) (*BranchEmpty, error) {
	out := new(BranchEmpty)
...
type BranchServiceServer interface {
	GetByID(context.Context, *BranchID) (*GetBranchResponse, error)
	GetList(context.Context, *GetListBranchRequest) (*GetListBranchResponse, error)
	Create(context.Context, *CreateBranchRequest) (*BranchResponse, error)
	Update(context.Context, *UpdateBranchRequest) (*GetBranchResponse, error)
	Delete(context.Context, *BranchID) (*BranchEmpty, error)
...
func (UnimplementedBranchServiceServer) GetByID(context.Context, *BranchID) (*GetBranchResponse, error) {
...
func (UnimplementedBranchServiceServer) Create(context.Context, *CreateBranchRequest) (*BranchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedBranchServiceServer) Update(context.Context, *UpdateBranchRequest) (*GetBranchResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedBranchServiceServer) Delete(context.Context, *BranchID) (*BranchEmpty, error) {
...
func _BranchService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BranchServiceServer).GetByID(ctx, req.(*BranchID))
	}
...
func _BranchService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BranchServiceServer).Delete(ctx, req.(*BranchID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BranchService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "education_management_service.BranchService",
