...
const (
	TaskService_GetByID_FullMethodName = "/education_management_service.TaskService/GetByID"
	TaskService_GetList_FullMethodName = "/education_management_service.TaskService/GetList"
	TaskService_Create_FullMethodName  = "/education_management_service.TaskService/Create"
	TaskService_Update_FullMethodName  = "/education_management_service.TaskService/Update"
	TaskService_Delete_FullMethodName  = "/education_management_service.TaskService/Delete"
)
...
type TaskServiceClient interface {
	GetByID(ctx context.Context, in *TaskID, opts ...grpc.CallOption) (*GetTaskResponse, error)
	...
	Update(ctx context.Context, in *UpdateTaskRequest, opts ...grpc.CallOption) (*GetTaskResponse, error)
	Delete(ctx context.Context, in *TaskID, opts ...grpc.CallOption) (*TaskEmpty, error)
}
...
func (c *taskServiceClient) GetByID(ctx context.Context, in *TaskID, opts ...grpc.CallOption) (*GetTaskResponse, error) {
...
func (c *taskServiceClient) Update(ctx context.Context, in *UpdateTaskRequest, opts ...grpc.CallOption) (*GetTaskResponse, error) {
	out := new(GetTaskResponse)
...
func (c *taskServiceClient) Delete(ctx context.Context, in *TaskID, opts ...grpc.CallOption) (*TaskEmpty, error) {
	out := new(TaskEmpty)
...
type TaskServiceServer interface {
	GetByID(context.Context, *TaskID) (*GetTaskResponse, error)
	...
	Update(context.Context, *UpdateTaskRequest) (*GetTaskResponse, error)
	Delete(context.Context, *TaskID) (*TaskEmpty, error)
...
func (UnimplementedTaskServiceServer) GetByID(context.Context, *TaskID) (*GetTaskResponse, error) {
...
func (UnimplementedTaskServiceServer) Update(context.Context, *UpdateTaskRequest) (*GetTaskResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedTaskServiceServer) Delete(context.Context, *TaskID) (*TaskEmpty, error) {
...
func _TaskService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).GetByID(ctx, req.(*TaskID))
	}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "education_management_service.TaskService",
